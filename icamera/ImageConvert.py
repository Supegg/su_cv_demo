...
import os
basedir = os.path.join(os.path.split(os.path.realpath(__file__))[0])
# 32bit
# ImageConvertdll = OleDLL("./dll/x86/ImageConvert.dll")
# ImageConvertdll = OleDLL(os.path.join(basedir, "dll/x86/ImageConvert.dll"))
# 64bit
# ImageConvertdll = OleDLL("./dll/x64/ImageConvert.dll")
ImageConvertdll = OleDLL(os.path.join(basedir, "dll/x64/ImageConvert.dll"))
